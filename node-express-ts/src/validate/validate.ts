class Validate{
    constructor(element : string ,value: any , minlenght : number, maxLenght : number , regex : any ,message : string){
        element = element,
        value = value,
        minlenght = minlenght,
        maxLenght = maxLenght,
...
function validateElement(user : any){
    let inputItem : any = document.querySelector('.'+user.element)
    const element : any = document.querySelector('#'+user.element)
